...
| **1.5 No standing Global Admins — but PIM not licensed** | At least 2 named Global Admin accounts, daily review of GA membership via automation (script that emails on drift), quarterly access review with signed attestation | **B — permanent** if EOL-licensing tier; **A — temporary** if waiting for Entra ID P2 add-on |
